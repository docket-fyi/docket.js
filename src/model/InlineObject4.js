...
class InlineObject4 {
     ...
     * @param data {module:model/SessionsData} 
     */
    constructor(data) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = SessionsData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/SessionsData}
     */
    getData() {
        return this.data;
    }
    ...
    /**
     * @param {module:model/SessionsData} data
     */
    setData(data) {
        this['data'] = data;
    }
...
/**
 * @member {module:model/SessionsData} data
 */
