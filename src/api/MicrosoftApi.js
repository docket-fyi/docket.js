...
export default class MicrosoftApi {
    ...
    */
    ...
    microsoftGetAccessTokens(code) {
      return this.microsoftGetAccessTokensWithHttpInfo(code)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    microsoftListCalendars() {
      return this.microsoftListCalendarsWithHttpInfo()
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    microsoftListEventsByCalendarIdWithHttpInfo(calendarId) {
      ...
      let returnType = InlineResponse2004;
      return this.apiClient.callApi(
        '/microsoft/calendars/{calendarId}/events', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    microsoftListEventsByCalendarId(calendarId) {
      return this.microsoftListEventsByCalendarIdWithHttpInfo(calendarId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
